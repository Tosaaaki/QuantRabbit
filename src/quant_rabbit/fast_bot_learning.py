...
LEARNING_ARM_POLICY_V2 = "QR_FAST_BOT_LEARNING_OFAT_ARMS_V2"
LEARNING_ARM_POLICY = LEARNING_ARM_POLICY_V2
...
LEARNING_ARM_SPECS_V2 = (
    *LEARNING_ARM_SPECS_V1,
    ("TP050", 0.0, BASE_ENTRY_TTL_SECONDS, BASE_MAX_HOLD_SECONDS, 0.50, 1.0, "TAKE_PROFIT"),
    ("TP075", 0.0, BASE_ENTRY_TTL_SECONDS, BASE_MAX_HOLD_SECONDS, 0.75, 1.0, "TAKE_PROFIT"),
    ("SL125", 0.0, BASE_ENTRY_TTL_SECONDS, BASE_MAX_HOLD_SECONDS, 1.0, 1.25, "STOP_LOSS"),
    ("SL150", 0.0, BASE_ENTRY_TTL_SECONDS, BASE_MAX_HOLD_SECONDS, 1.0, 1.50, "STOP_LOSS"),
    ("TTL45", 0.0, 45, BASE_MAX_HOLD_SECONDS, 1.0, 1.0, "ENTRY_TTL"),
    ("HOLD180", 0.0, BASE_ENTRY_TTL_SECONDS, 3 * 60, 1.0, 1.0, "HOLD_HORIZON"),
    ("HOLD300", 0.0, BASE_ENTRY_TTL_SECONDS, 5 * 60, 1.0, 1.0, "HOLD_HORIZON"),
    ("HOLD600", 0.0, BASE_ENTRY_TTL_SECONDS, 10 * 60, 1.0, 1.0, "HOLD_HORIZON"),
)
LEARNING_ARM_SPECS = LEARNING_ARM_SPECS_V2
...
def learning_arm_specs_for_policy(
    ...
    if arm_policy == LEARNING_ARM_POLICY_V2:
        return LEARNING_ARM_SPECS_V2
