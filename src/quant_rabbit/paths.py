...
DEFAULT_TRADER_DECISION_BASELINE = ROOT / "data" / "trader_decision_baseline.json"
DEFAULT_MARKET_READ_EVIDENCE_PACKET = ROOT / "data" / "market_read_evidence_packet.json"
DEFAULT_CODEX_MARKET_READ_OVERLAY = ROOT / "data" / "codex_market_read_overlay.json"
...
DEFAULT_GUARDIAN_TUNING_WORK_ORDER = ROOT / "data" / "guardian_tuning_work_order.json"
...
DEFAULT_OPERATOR_REVIEW_REPORT = ROOT / "data" / "operator_review_report.json"
DEFAULT_OPERATOR_REVIEW_REPORT_MD = ROOT / "docs" / "operator_review_report.md"
DEFAULT_PREDICTIVE_SCOUT_FORWARD_PROOF = ROOT / "data" / "predictive_scout_forward_proof.json"
DEFAULT_PREDICTIVE_SCOUT_FORWARD_PROOF_REPORT = ROOT / "docs" / "predictive_scout_forward_proof_report.md"
...
DEFAULT_AUTONOMOUS_SHADOW_INPUT = ROOT / "data" / "autonomous_shadow_cycle_input.json"
DEFAULT_AUTONOMOUS_SHADOW_LEDGER = ROOT / "data" / "autonomous_shadow_synapse_ledger.jsonl"
DEFAULT_AUTONOMOUS_SHADOW_STATE = ROOT / "data" / "autonomous_shadow_nervous_system.json"
DEFAULT_AUTONOMOUS_SHADOW_REPORT = ROOT / "docs" / "autonomous_shadow_nervous_system_report.md"
...
DEFAULT_ENTRY_FREQUENCY_RECOVERY = ROOT / "data" / "entry_frequency_recovery.json"
DEFAULT_ENTRY_FREQUENCY_RECOVERY_REPORT = ROOT / "docs" / "entry_frequency_recovery_report.md"
DEFAULT_FORECAST_PATTERN_REFRESH = ROOT / "data" / "forecast_pattern_refresh.json"
DEFAULT_FORECAST_PATTERN_REFRESH_REPORT = ROOT / "docs" / "forecast_pattern_refresh_report.md"
DEFAULT_RANGE_RAIL_GEOMETRY_REPAIR = ROOT / "data" / "range_rail_geometry_repair.json"
DEFAULT_RANGE_RAIL_GEOMETRY_REPAIR_REPORT = ROOT / "docs" / "range_rail_geometry_repair_report.md"
DEFAULT_NON_EURUSD_PROOF_LANE_MAPPER = ROOT / "data" / "non_eurusd_proof_lane_mapper.json"
DEFAULT_NON_EURUSD_PROOF_LANE_MAPPER_REPORT = ROOT / "docs" / "non_eurusd_proof_lane_mapper.md"
DEFAULT_NON_EURUSD_LIVE_GRADE_FRONTIER = ROOT / "data" / "non_eurusd_live_grade_frontier.json"
DEFAULT_NON_EURUSD_LIVE_GRADE_FRONTIER_REPORT = ROOT / "docs" / "non_eurusd_live_grade_frontier.md"
...
DEFAULT_TP_REBALANCE = ROOT / "data" / "tp_rebalance.json"
