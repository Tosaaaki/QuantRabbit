...
def _precision_index_from_intents(intents: dict[str, Any]) -> dict[str, dict[str, Any]]:
    ...
    for item in intents.get("results", []) or []:
        ...
        out[lane_id] = {
            ...
            "range_24h_expansion_ratio": _optional_float(metadata.get("range_24h_expansion_ratio")),
            "range_24h_expansion_percentile": _optional_float(metadata.get("range_24h_expansion_percentile")),
            "range_24h_expansion_upper_fence": _optional_float(metadata.get("range_24h_expansion_upper_fence")),
            "range_24h_expansion_outlier": metadata.get("range_24h_expansion_outlier"),
