...
def run(input_root: Path, source_ledger: Path, output_root: Path) -> dict:
    ...
    ledger = output_root / "proposal_ledger_major_session_h192_v10.jsonl"
    ledger.write_text("".join(json.dumps(row, sort_keys=True, allow_nan=False) + "\n" for row in rows), encoding="utf-8")
    payload = {
        "experiment": "FX_AUCTION_TRAP_LIQUID_MAJORS_H192_V10",
        "evidence_class": "opened_development_not_future_holdout",
        "single_changed_variable": "fixed_horizon_96_to_192_m5_bars",
    ...
    result = output_root / "result_major_session_horizon_v10.json"
