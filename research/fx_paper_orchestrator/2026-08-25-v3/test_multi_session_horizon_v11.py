...
from run_multi_session_horizon_v11 import HORIZON, rescore


class MultiSessionHorizonTest(unittest.TestCase):
    def fixture(self):
        rows = []
    ...
    def test_finite_384_bar_horizon_and_cost_order(self):
        rows = self.fixture()
