...
Usage:
  python3 tools/task_lock.py acquire <lock_name> <timeout_minutes> [--pid <PID>] [--caller <caller_name>]
  python3 tools/task_lock.py release <lock_name> [--caller <caller_name>]
  python3 tools/task_lock.py status
