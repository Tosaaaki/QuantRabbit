...
def test_rsi_take_closes_once_profit_buffer_is_met(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    exit_worker, worker = _build_worker(monkeypatch)
