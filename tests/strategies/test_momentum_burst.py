...
def test_transition_long_pullback_guard_blocks_overbought_upper_wick_chase() -> None:
    blocked = MomentumBurstMicro._transition_long_pullback_ok(
        {
...
def test_transition_long_pullback_guard_keeps_controlled_pullback_entry() -> None:
    allowed = MomentumBurstMicro._transition_long_pullback_ok(
        {
            "range_mode": "transition",
            "trend_snapshot": {
                "tf": "H4",
...
def test_transition_long_blocks_overbought_upper_wick_chase() -> None:
    signal = MomentumBurstMicro.check(
        {
            "close": 159.592,
            "ma10": 159.578,
