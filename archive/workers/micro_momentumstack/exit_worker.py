"""Dedicated exit worker for MicroMomentumStack strategy.
...
os.environ.setdefault("MICRO_MULTI_LOG_PREFIX", "[MicroMomentumStack]")
os.environ.setdefault("MICRO_MULTI_EXIT_TAG_ALLOWLIST", "MicroMomentumStack")
