"""Dedicated exit worker for MicroVWAPRevert strategy.
...
os.environ.setdefault("MICRO_MULTI_LOG_PREFIX", "[MicroVWAPRevert]")
os.environ.setdefault("MICRO_MULTI_EXIT_TAG_ALLOWLIST", "MicroVWAPRevert")
...
async def micro_vwaprevert_exit_worker() -> None:
...
if __name__ == "__main__":  # pragma: no cover
    ...
    asyncio.run(micro_vwaprevert_exit_worker())
