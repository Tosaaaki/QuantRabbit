...
async def _place_order(
    ...
    *,
    ...
    sizing = compute_units(
        ...
        strategy_tag=str(signal.get("tag") or "scalp_squeeze_pulse_break"),
        env_prefix=config.ENV_PREFIX,
    )
    ...
    client_id = _client_order_id(str(signal.get("tag") or "scalp_squeeze_pulse_break"))
...
async def scalp_squeeze_pulse_break_worker() -> None:
...
def main() -> None:
    ...
    asyncio.run(scalp_squeeze_pulse_break_worker())
