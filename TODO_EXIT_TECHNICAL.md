...
- 下記 17 ワーカーはすべて専用 exit_worker 実装済みで、PnL>0 決済・最低保有・range タイト化を備える。共通 ExitManager はスタブ化済み。
  - scalp/fast 系: fast_scalp / pullback_s5 / mirror_spike_s5 / squeeze_break_s5 / vwap_magnet_s5 / impulse_momentum_s5 / impulse_retest_s5 / pullback_runner_s5 / pullback_scalp / mirror_spike_tight / scalp_multistrat
