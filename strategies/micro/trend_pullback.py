...
_MIN_ADX = _float_env("MICRO_TREND_MIN_ADX", 18.0)
_MIN_ATR_PIPS = _float_env("MICRO_TREND_MIN_ATR_PIPS", 1.4)
_MAX_PULLBACK_PIPS = _float_env("MICRO_TREND_MAX_PULLBACK_PIPS", 8.5)
_MAX_RSI_BUY = _float_env("MICRO_TREND_MAX_RSI", 67.0)
_MIN_RSI_SELL = _float_env("MICRO_TREND_MIN_RSI", 33.0)
_SL_ATR_MULT = _float_env("MICRO_TREND_SL_ATR_MULT", 0.85)
_TP_MULT = _float_env("MICRO_TREND_TP_MULT", 1.7)
_TTL_SEC = int(_float_env("MICRO_TREND_TTL_SEC", 1500))
_MIN_MA_SPREAD_PIPS = _float_env("MICRO_TREND_MIN_MA_SPREAD_PIPS", 4.0)
_REQUIRE_H4_CONFIRM = _bool_env("MICRO_TREND_REQUIRE_H4_CONFIRM", True)

_EXHAUST_ATR_MULT = _float_env("MICRO_TREND_EXHAUST_ATR_MULT", 2.6)
_EXHAUST_MIN_PIPS = _float_env("MICRO_TREND_EXHAUST_MIN_PIPS", 10.0)
_EXHAUST_RSI_BUY = _float_env("MICRO_TREND_EXHAUST_RSI_BUY", 34.0)
_EXHAUST_RSI_SELL = _float_env("MICRO_TREND_EXHAUST_RSI_SELL", 66.0)
_COUNTER_SL_MULT = _float_env("MICRO_TREND_COUNTER_SL_ATR_MULT", 1.3)
_COUNTER_TP_MULT = _float_env("MICRO_TREND_COUNTER_TP_MULT", 1.4)
_COUNTER_SL_MIN = _float_env("MICRO_TREND_COUNTER_SL_MIN_PIPS", 10.0)
_MOMENTUM_FLOOR = _float_env("MICRO_TREND_MOMENTUM_FLOOR", -0.3)
_MOMENTUM_CAP = _float_env("MICRO_TREND_MOMENTUM_CAP", 1.5)
_PULLBACK_MOM_ABS = _float_env("MICRO_TREND_PULLBACK_MOM_ABS", 1.8)
_PULLBACK_VEL_ABS = _float_env("MICRO_TREND_PULLBACK_VEL_ABS", 2.4)
_PULLBACK_VWAP_ABS = _float_env("MICRO_TREND_PULLBACK_VWAP_ABS", 4.5)
_COUNTER_TICK_CAP = _float_env("MICRO_TREND_COUNTER_TICK_CAP", 0.9)
_COUNTER_VEL_CAP = _float_env("MICRO_TREND_COUNTER_VEL_CAP", 0.8)
_COUNTER_VWAP_MIN = _float_env("MICRO_TREND_COUNTER_VWAP_MIN", 1.2)
_MIN_TICK_RANGE = _float_env("MICRO_TREND_MIN_TICK_RANGE", 0.5)
_STRONG_TREND_ADX = _float_env("MICRO_TREND_STRONG_ADX", 28.0)
_STRONG_TREND_SPREAD_PIPS = _float_env("MICRO_TREND_STRONG_SPREAD_PIPS", 6.0)
_STRONG_TREND_SL_BOOST = _float_env("MICRO_TREND_STRONG_SL_BOOST", 1.25)
