...
def build_messages(payload: Dict) -> List[Dict]:
    ...
    lines = [
        ...
        f"Technical factors M5: {json.dumps(payload.get('factors_m5', {}))}",
        f"Technical factors H1: {json.dumps(payload.get('factors_h1', {}))}",
        f"Technical factors H4: {json.dumps(payload.get('factors_h4', {}))}",
        f"Technical factors D1: {json.dumps(payload.get('factors_d1', {}))}",
