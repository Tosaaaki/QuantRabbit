...
if RELEASE_SPREAD_PIPS >= MAX_SPREAD_PIPS:
    RELEASE_SPREAD_PIPS = max(MAX_SPREAD_PIPS * 0.85, MAX_SPREAD_PIPS - 0.2)

WINDOW_SECONDS = _load_float("spread_guard_window_sec", 4.5, minimum=0.5)
COOLDOWN_SECONDS = _load_float("spread_guard_cooldown_sec", 25.0, minimum=5.0)
...
BASELINE_WINDOW_SECONDS = _load_float(
    "spread_guard_baseline_window_sec", 300.0, minimum=10.0
)
