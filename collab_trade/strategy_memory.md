...
最終更新: 2026-04-10 06:00 UTC (daily-review)
...
- [4/9] **Recovery day structure**: Morning SHORTs lost -2,971 JPY (AUD_USD -2,699 SL hit, USD_JPY SHORT -270, EUR_USD SHORT -2). Afternoon LONG pivot recovered to net +1,045 JPY (12 trades, 67%WR). USD_JPY LONG 5000u held 398min=+1,220 JPY. EUR_USD LONG ×2=+2,198 JPY. Regime pivot mid-day was the key skill.
- [4/9] **Margin crisis 3rd occurrence (98%)**: AUD_USD 4000u forced close at -1,016 JPY. Verified 3x (4/1+4/8+4/9) → promoted to Confirmed. Above 85% = STOP ADDING.
...
|--------|-------------------|---------|------------------|----------|--------|
| Structural-S | 7 | 1 | 7/7 | 100% | **Best recipe** — trust it. AUD_USD SHORT @0.7033/0.7036 NOT_HELD both CORRECT (4/9) |
| Momentum-S | 50+ | 0 | ~50/50 | ~100% | **NEW (4/9)** — 50+ fires all LONG, market +50-60pip. Need tracking. |
