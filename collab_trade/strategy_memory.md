...
最終更新: 2026-04-09 06:00 UTC (daily-review)
...
- [4/9] **0% WR day — all 3 closed trades lost**: AUD_USD -2,699, USD_JPY -270, EUR_USD -2. Total -2,971 JPY. No single catastrophic error; cumulative losses from marginal entries. AUD_USD 7500u S-size on a pair with no edge (all-time 48%WR, avg -78JPY) was the biggest contributor
- [4/9] **Margin crisis 3rd occurrence (98%)**: AUD_USD 4000u forced close at -1,016 JPY from 98.1% margin. Same as 4/1 and 4/8. This is now verified 3x → **promote to Confirmed**. Pending LIMITs + stacking = margin emergency every time. Verified: 3x (4/1 + 4/8 + 4/9)
...
- **4/9: 7500u LONG S-conviction @0.70474 → -2,699 JPY** — entered because "Trend-Dip-S recipe fired + quality audit flagged miss." Same mistake as 4/8: S-sizing on a historically losing pair. Two consecutive S-size entries lost 5,239 JPY in 2 days. **AUD_USD should be CAPPED at A-size (5000u) maximum regardless of S-scan signal**
...
|--------|-------------------|---------|------------------|----------|--------|
| Structural-S | 4 | 1 | 4/4 | 100% | **Best recipe** — trust it |
| Trend-Dip-S | 12 | 4 | 3/12 | 25% | **Watch** — fires contradictory signals within 2h. Too noisy |
| Squeeze-S | 4 | 0 | 0/4 | 0% | **Suspect** — all signals wrong on 4/9. Needs 10+ data points |
| Counter | 0 | 0 | - | - | No data yet |

**4/9 details**:
- Structural-S: USD_JPY LONG @158.712→158.844(+13.2pip)✓, EUR_JPY LONG @185.151→185.237(+8.6pip)✓, AUD_JPY LONG @111.686→111.749(+6.3pip)✓
- Trend-Dip-S: fired EUR_USD SHORT @02:03Z then EUR_USD LONG @03:33Z (contradictory). GBP_JPY LONG @212.59→212.709(+11.9pip)✓ was correct. AUD_USD SHORT @0.70341→0.70354 WRONG
- Squeeze-S: EUR_USD SHORT @1.16518→1.16616(-9.8pip) WRONG. All USD_JPY LONG signals flat

**Next review**: need 10+ total signals per recipe before changing status. Priority: watch Trend-Dip-S for contradiction frequency
