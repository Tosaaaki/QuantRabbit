...
- **THE GOOD DAY RECIPE — 5 good days shared these 4 traits (4/7, 4/13, 4/10, 4/1, 3/25)**:
  - **Hero pair concentration**: 1 pair produces 36-143% of daily P&L. 4/7: EUR_USD=53%. 4/1: EUR_USD=143%. Spreading across 5+ pairs equally = mediocre day (+1,291 avg)
  - **Rotation on hero pair**: TP → re-enter within 60min. 4/7: EUR_USD 7 rotations → +5,880. Rotation P&L all-time = +72,774 JPY. Everything else combined = -73,529 JPY. **Rotation IS the system**
  - **Size escalation**: proving(3k) → confirmed(4-8k). 4/7: EUR_USD 500u→2000u→4000u→5000u. The 7th trade was 10× the 1st. Same setup, just proven
  - **WR 67-75%**: Good days have the direction RIGHT. Bad days have WR 32% (direction wrong, kept pushing)
  - **Good day stats**: avg units 2,779 | WR 71% | best trade +2,062 | 30-120min hold 39%
  - **Bad day stats**: avg units 2,256 | WR 32% | worst trade -2,410 | avg hold 477min (zombie holds)
...
- **MOMENTUM-S = FREE MONEY (55+ fires, 0 entries, 96% accuracy)**:
  - 55+ times the scanner fired Momentum-S. ZERO entered. Estimated missed: +7,680 JPY minimum
  - Momentum-S fires when: CS gap ≥0.8 + H4+H1+M5 all aligned + ADX>20. When 3+ pairs fire same direction = currency-wide move
  - Why 0 entries: trader reads it as "supplementary data," does full analysis, finds one AGAINST, rates B, places LIMIT, cancels next session. Signal was right every time
  - **When ≥3 pairs fire Momentum-S same direction: enter hero pair A-size (4,000u) market order. Not LIMIT. Not B-size. Not "consider." ENTER.**

**⚡ You just read 20+ proven winning patterns. Now go find one in today's market and ENTER.**
...
- **4/7を基準にしろ**: 31エントリー, EUR_USD 7回転+5,880, AUD_USD 1発+3,366, total +11,014。Hero pair集中+回転+サイズ階段。これが目指す姿
- **回転がないと稼げない**: 回転P&L = +72,774 JPY。回転以外 = -73,529 JPY。TP後30秒以内にLIMIT再エントリー。回転を止めた瞬間に利益が止まる
