...
H4_EXTREME_WINDOW = int(os.getenv("TRENDMA_H4_EXTREME_WINDOW", "24"))
H4_NEAR_HIGH_PIPS = float(os.getenv("TRENDMA_H4_NEAR_HIGH_PIPS", "8.0"))
H4_NEAR_LOW_PIPS = float(os.getenv("TRENDMA_H4_NEAR_LOW_PIPS", "8.0"))
MIN_FREE_MARGIN_RATIO = float(os.getenv("TRENDMA_MIN_FREE_MARGIN_RATIO", "0.10"))
