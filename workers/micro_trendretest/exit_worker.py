"""Dedicated exit worker for MicroTrendRetest strategy."""
...
os.environ.setdefault("MICRO_MULTI_LOG_PREFIX", "[MicroTrendRetest]")
os.environ.setdefault("MICRO_MULTI_EXIT_TAG_ALLOWLIST", "MicroTrendRetest")
