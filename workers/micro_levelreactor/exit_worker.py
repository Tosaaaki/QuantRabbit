"""Dedicated exit worker for MicroLevelReactor strategy.
...
os.environ.setdefault("MICRO_MULTI_LOG_PREFIX", "[MicroLevelReactor]")
os.environ.setdefault("MICRO_MULTI_EXIT_TAG_ALLOWLIST", "MicroLevelReactor")
