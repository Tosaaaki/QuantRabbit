...
async def scalp_impulseretrace_worker() -> None:
    ...
    try:
        while True:
            ...
            signal = ImpulseRetraceScalp.check(fac_m1)
            if not signal:
                continue
            ...
            signal_tag = (signal.get("tag") or "").strip() or ImpulseRetraceScalp.name
...
if __name__ == "__main__":
    asyncio.run(scalp_impulseretrace_worker())
