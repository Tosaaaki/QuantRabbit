...
MICRO_MAX_ACTIVE_TRADES = max(0, int(os.getenv("MICRO_MAX_ACTIVE_TRADES", "2")))
MICRO_MAX_TRADES_PER_DIRECTION = max(
    0, int(os.getenv("MICRO_MAX_TRADES_PER_DIRECTION", "2"))
)
MICRO_MAX_TRADES_PER_STRATEGY = max(
    0, int(os.getenv("MICRO_MAX_TRADES_PER_STRATEGY", "1"))
)
