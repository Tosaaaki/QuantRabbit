...
TICK_IMB_EXHAUSTION_SHORT_RSI_MAX = _env_float(
    "TICK_IMB_EXHAUSTION_SHORT_RSI_MAX", 24.0
)
TICK_IMB_EXHAUSTION_VWAP_GAP_MIN_PIPS = _env_float(
    "TICK_IMB_EXHAUSTION_VWAP_GAP_MIN_PIPS", 4.5
)
TICK_IMB_EXHAUSTION_EMA_SLOPE_MIN_PIPS = _env_float(
    "TICK_IMB_EXHAUSTION_EMA_SLOPE_MIN_PIPS", 0.55
)
TICK_IMB_EXHAUSTION_MACD_HIST_MIN_PIPS = _env_float(
    "TICK_IMB_EXHAUSTION_MACD_HIST_MIN_PIPS", 1.2
)
...
async def _place_order(
    ...
    *,
    ...
    sizing = compute_units(
        ...
        strategy_tag=str(signal.get("tag") or "scalp_tick_imbalance"),
        env_prefix=config.ENV_PREFIX,
    )
    ...
    client_id = _client_order_id(str(signal.get("tag") or "scalp_tick_imbalance"))
...
async def scalp_tick_imbalance_worker() -> None:
...
def main() -> None:
    ...
    asyncio.run(scalp_tick_imbalance_worker())
