...
SLOW_Z_BLOCK: float = max(0.0, _float("MIRROR_SPIKE_S5_SLOW_Z_BLOCK", 2.4))
RANGE_ONLY: bool = _bool("MIRROR_SPIKE_S5_RANGE_ONLY", True)
...
MAX_MARGIN_USAGE: float = max(0.1, min(1.0, _float("MIRROR_SPIKE_S5_MAX_MARGIN_USAGE", 0.9)))
...
MIN_RETRACE_PIPS: float = max(0.2, _float("MIRROR_SPIKE_S5_MIN_RETRACE_PIPS", 1.2))
MIN_WICK_RATIO: float = max(1.0, _float("MIRROR_SPIKE_S5_MIN_WICK_RATIO", 2.4))
