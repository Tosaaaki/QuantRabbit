...
def _serialize_decision(decision: forecast_gate.ForecastDecision) -> dict[str, Any]:
    return {
        ...
        "edge": decision.edge,
        "p_up": decision.p_up,
        "rebound_probability": decision.rebound_probability,
        "expected_pips": decision.expected_pips,
        "anchor_price": decision.anchor_price,
        "target_price": decision.target_price,
        "range_low_pips": decision.range_low_pips,
        "range_high_pips": decision.range_high_pips,
        "range_sigma_pips": decision.range_sigma_pips,
        "range_low_price": decision.range_low_price,
        "range_high_price": decision.range_high_price,
        "tp_pips_hint": decision.tp_pips_hint,
        "target_reach_prob": decision.target_reach_prob,
