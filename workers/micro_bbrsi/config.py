...
CAP_MAX = float(os.getenv("BBRSI_CAP_MAX", "0.8"))

NEWS_BLOCK_MINUTES = float(os.getenv("BBRSI_NEWS_BLOCK_MINUTES", "0"))
NEWS_BLOCK_MIN_IMPACT = int(os.getenv("BBRSI_NEWS_BLOCK_IMPACT", "2"))
