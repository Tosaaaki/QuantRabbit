...
MAX_SPREAD_PIPS: float = max(0.1, _float("PULLBACK_RUNNER_S5_MAX_SPREAD_PIPS", 0.85))
...
MIN_SL_PIPS: float = max(1.0, _float("PULLBACK_RUNNER_S5_MIN_SL_PIPS", 3.0))
SL_ATR_MULT: float = max(0.5, _float("PULLBACK_RUNNER_S5_SL_ATR_MULT", 1.2))
MAX_SL_PIPS: float = max(1.0, _float("PULLBACK_RUNNER_S5_MAX_SL_PIPS", 2.8))
...
COOLDOWN_SEC: float = max(10.0, _float("PULLBACK_RUNNER_S5_COOLDOWN_SEC", 120.0))
