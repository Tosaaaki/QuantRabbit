...
def _map_exit_env_prefix() -> None:
    ...
    os.environ.setdefault("SCALP_FALSE_BREAK_FADE_EXIT_TAGS", os.getenv(f"{_EXIT_ENV_PREFIX}_TAGS", "FalseBreakFade"))
    ...
    os.environ.setdefault(
        ...
        os.getenv(f"{_EXIT_ENV_PREFIX}_PROFILE_ENABLED", os.getenv("SCALP_FALSE_BREAK_FADE_EXIT_PROFILE_ENABLED", "1")),
    )
    os.environ.setdefault(
...
_STRATEGY_PROTECTION_PATH = pathlib.Path(
    os.getenv("SCALP_FALSE_BREAK_FADE_EXIT_PROFILE_PATH", os.getenv("STRATEGY_PROTECTION_PATH", "config/strategy_exit_protections.yaml"))
)
_STRATEGY_PROTECTION_ENABLED = os.getenv("SCALP_FALSE_BREAK_FADE_EXIT_PROFILE_ENABLED", "1").strip().lower() not in _FALSEY
...
class RangeFaderExitWorker:
    def __init__(self) -> None:
        ...
        self.exit_policy_start_ts = load_rollout_start_ts("SCALP_FALSE_BREAK_FADE_EXIT_POLICY_START_TS")
