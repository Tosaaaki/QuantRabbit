...
# Dynamic TP/SL (range-based, not ATR-based)
SL_MIN_PIPS: float = max(0.5, _float("MIRROR_SPIKE_TIGHT_SL_MIN_PIPS", SL_PIPS))
SL_MAX_PIPS: float = max(SL_MIN_PIPS, _float("MIRROR_SPIKE_TIGHT_SL_MAX_PIPS", 2.2))
TP_MIN_PIPS: float = max(0.5, _float("MIRROR_SPIKE_TIGHT_TP_MIN_PIPS", TP_PIPS))
TP_MAX_PIPS: float = max(TP_MIN_PIPS, _float("MIRROR_SPIKE_TIGHT_TP_MAX_PIPS", 4.0))
SL_RANGE_RATIO: float = max(0.05, _float("MIRROR_SPIKE_TIGHT_SL_RANGE_RATIO", 0.18))
TP_RANGE_RATIO: float = max(0.1, _float("MIRROR_SPIKE_TIGHT_TP_RANGE_RATIO", 0.32))
TP_SL_RATIO: float = max(1.2, _float("MIRROR_SPIKE_TIGHT_TP_SL_RATIO", 2.0))
SL_SPREAD_MULT: float = max(1.0, _float("MIRROR_SPIKE_TIGHT_SL_SPREAD_MULT", 3.0))
...
BLOCK_MARU_UP_SHORT: bool = _bool("MIRROR_SPIKE_TIGHT_BLOCK_MARU_UP_SHORT", True)
BLOCK_MARU_DN_LONG: bool = _bool("MIRROR_SPIKE_TIGHT_BLOCK_MARU_DN_LONG", True)
