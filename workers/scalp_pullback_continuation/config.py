...
LOG_PREFIX = "[PullbackContinuation]"
...
SIGNAL_TAG_CONTAINS = frozenset(
    _parse_csv_lower(
        ...
        or _load_env_file().get("M1SCALP_SIGNAL_TAG_CONTAINS", "buy-dip,sell-rally")
    )
)
...
STRATEGY_TAG_OVERRIDE = (
    ...
    or _load_env_file().get("M1SCALP_STRATEGY_TAG_OVERRIDE", "PullbackContinuation")
).strip()
