...
MAX_SPREAD_PIPS = _float("ONEPIP_MAKER_S1_MAX_SPREAD_PIPS", 0.24, minimum=0.05)
...
MAX_SNAPSHOT_AGE_MS = _float("ONEPIP_MAKER_S1_MAX_SNAPSHOT_AGE_MS", 60.0, minimum=10.0)
...
ENTRY_UNITS = _int("ONEPIP_MAKER_S1_ENTRY_UNITS", 5000, minimum=1000)
SL_PIPS = _float("ONEPIP_MAKER_S1_SL_PIPS", 1.2, minimum=0.2)
TP_PIPS = _float("ONEPIP_MAKER_S1_TP_PIPS", 1.3, minimum=0.2)
POCKET = os.getenv("ONEPIP_MAKER_S1_POCKET", "micro").strip() or "micro"
MIN_UNITS = _int("ONEPIP_MAKER_S1_MIN_UNITS", 1500, minimum=200)
MAX_UNITS = _int("ONEPIP_MAKER_S1_MAX_UNITS", 6000, minimum=1000)
...
MAX_SNAPSHOT_LATENCY_MS = _float("ONEPIP_MAKER_S1_MAX_LATENCY_MS", 40.0, minimum=5.0)
