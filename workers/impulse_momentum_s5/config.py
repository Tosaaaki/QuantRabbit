...
MAX_SPREAD_PIPS: float = max(0.1, _float("IMPULSE_MOMENTUM_S5_MAX_SPREAD_PIPS", 0.45))
...
ENTRY_UNITS: int = max(1000, _int("IMPULSE_MOMENTUM_S5_ENTRY_UNITS", 6000))
MAX_ACTIVE_TRADES: int = max(1, _int("IMPULSE_MOMENTUM_S5_MAX_ACTIVE_TRADES", 1))
COOLDOWN_SEC: float = max(15.0, _float("IMPULSE_MOMENTUM_S5_COOLDOWN_SEC", 90.0))
...
NEWS_BLOCK_MINUTES: float = max(
    0.0, _float("IMPULSE_MOMENTUM_S5_NEWS_BLOCK_MINUTES", 15.0)
)
NEWS_BLOCK_MIN_IMPACT: int = max(
    1, _int("IMPULSE_MOMENTUM_S5_NEWS_BLOCK_MIN_IMPACT", 2)
)
