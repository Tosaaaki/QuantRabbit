...
PIP_VALUE = 0.01
ENV_PREFIX = "IMPULSE_MOMENTUM_S5"
...
MAX_SPREAD_PIPS: float = max(0.1, _float("IMPULSE_MOMENTUM_S5_MAX_SPREAD_PIPS", 1.3))
...
ENTRY_UNITS: int = max(500, _int("IMPULSE_MOMENTUM_S5_ENTRY_UNITS", 6000))
MAX_ACTIVE_TRADES: int = max(1, _int("IMPULSE_MOMENTUM_S5_MAX_ACTIVE_TRADES", 2))
COOLDOWN_SEC: float = max(45.0, _float("IMPULSE_MOMENTUM_S5_COOLDOWN_SEC", 90.0))
POST_EXIT_COOLDOWN_SEC: float = max(0.0, _float("IMPULSE_MOMENTUM_S5_POST_EXIT_COOLDOWN_SEC", 120.0))

MIN_ATR_PIPS: float = max(0.0, _float("IMPULSE_MOMENTUM_S5_MIN_ATR_PIPS", 0.6))
...
FAST_Z_LONG_MIN: float = _float("IMPULSE_MOMENTUM_S5_FAST_Z_LONG_MIN", 0.7)
FAST_Z_SHORT_MAX: float = _float("IMPULSE_MOMENTUM_S5_FAST_Z_SHORT_MAX", -0.7)
SLOW_Z_LONG_MIN: float = _float("IMPULSE_MOMENTUM_S5_SLOW_Z_LONG_MIN", 0.25)
SLOW_Z_SHORT_MAX: float = _float("IMPULSE_MOMENTUM_S5_SLOW_Z_SHORT_MAX", -0.25)
...
MIN_BREAKOUT_PIPS: float = max(0.2, _float("IMPULSE_MOMENTUM_S5_MIN_BREAKOUT_PIPS", 0.5))
...
TREND_ADX_MIN: float = max(0.0, _float("IMPULSE_MOMENTUM_S5_TREND_ADX_MIN", 14.0))
TREND_SLOPE_MIN_PIPS: float = max(0.0, _float("IMPULSE_MOMENTUM_S5_TREND_SLOPE_MIN_PIPS", 0.08))
