...
PREC_LOWVOL_SPREAD_P25 = float(os.getenv("SCALP_PRECISION_PREC_LOWVOL_SPREAD_P25", "1.6"))
PREC_LOWVOL_REV_MIN_STRENGTH = float(os.getenv("SCALP_PRECISION_PREC_LOWVOL_REV_MIN_STRENGTH", "0.35"))
