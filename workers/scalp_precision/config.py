...
PREC_LOWVOL_RANGE_SCORE = float(os.getenv("SCALP_PRECISION_PREC_LOWVOL_RANGE_SCORE", "0.45"))
PREC_LOWVOL_ADX_MAX = float(os.getenv("SCALP_PRECISION_PREC_LOWVOL_ADX_MAX", "24.0"))
PREC_LOWVOL_BBW_MAX = float(os.getenv("SCALP_PRECISION_PREC_LOWVOL_BBW_MAX", "0.26"))
PREC_LOWVOL_ATR_MIN = float(os.getenv("SCALP_PRECISION_PREC_LOWVOL_ATR_MIN", "0.6"))
PREC_LOWVOL_ATR_MAX = float(os.getenv("SCALP_PRECISION_PREC_LOWVOL_ATR_MAX", "3.6"))
PREC_LOWVOL_BB_TOUCH_PIPS = float(os.getenv("SCALP_PRECISION_PREC_LOWVOL_BB_TOUCH_PIPS", "1.0"))
PREC_LOWVOL_RSI_LONG_MAX = float(os.getenv("SCALP_PRECISION_PREC_LOWVOL_RSI_LONG_MAX", "48.0"))
PREC_LOWVOL_RSI_SHORT_MIN = float(os.getenv("SCALP_PRECISION_PREC_LOWVOL_RSI_SHORT_MIN", "52.0"))
PREC_LOWVOL_STOCH_LONG_MAX = float(os.getenv("SCALP_PRECISION_PREC_LOWVOL_STOCH_LONG_MAX", "0.4"))
PREC_LOWVOL_STOCH_SHORT_MIN = float(os.getenv("SCALP_PRECISION_PREC_LOWVOL_STOCH_SHORT_MIN", "0.6"))
PREC_LOWVOL_VWAP_GAP_MIN = float(os.getenv("SCALP_PRECISION_PREC_LOWVOL_VWAP_GAP_MIN", "0.2"))
PREC_LOWVOL_SPREAD_P25 = float(os.getenv("SCALP_PRECISION_PREC_LOWVOL_SPREAD_P25", "1.1"))
PREC_LOWVOL_REV_MIN_STRENGTH = float(os.getenv("SCALP_PRECISION_PREC_LOWVOL_REV_MIN_STRENGTH", "0.8"))
