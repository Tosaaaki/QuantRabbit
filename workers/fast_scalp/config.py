...
ENTRY_THRESHOLD_PIPS: float = max(0.05, float(os.getenv("FAST_SCALP_ENTRY_MOM_PIPS", "0.35")))
ENTRY_SHORT_THRESHOLD_PIPS: float = max(
    0.02, float(os.getenv("FAST_SCALP_ENTRY_SHORT_MOM_PIPS", "0.2"))
)
ENTRY_RANGE_FLOOR_PIPS: float = max(0.1, float(os.getenv("FAST_SCALP_RANGE_FLOOR_PIPS", "0.7")))
ENTRY_COOLDOWN_SEC: float = max(0.5, float(os.getenv("FAST_SCALP_ENTRY_COOLDOWN_SEC", "2.5")))
