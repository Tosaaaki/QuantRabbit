...
PROJ_FLIP_MARGIN = float(os.getenv("M1SCALP_PROJ_FLIP_MARGIN", "0.18"))
PROJ_FLIP_MIN_SCORE = float(os.getenv("M1SCALP_PROJ_FLIP_MIN_SCORE", "0.15"))
PROJ_FLIP_MAX_SCORE = float(os.getenv("M1SCALP_PROJ_FLIP_MAX_SCORE", "-0.15"))
