...
MIN_CONFIDENCE: int = max(40, _int("TREND_H1_MIN_CONFIDENCE", 48))
CONFIDENCE_FLOOR: int = max(30, _int("TREND_H1_CONFIDENCE_FLOOR", 42))
...
MIN_LOT: float = max(0.0, _float("TREND_H1_MIN_LOT", 0.002))
MAX_LOT: float = max(MIN_LOT, _float("TREND_H1_MAX_LOT", 0.08))
RISK_PCT: float = max(0.0005, _float("TREND_H1_RISK_PCT", 0.015))
MIN_UNITS: int = max(500, _int("TREND_H1_MIN_UNITS", 2000))
...
ENTRY_COOLDOWN_SEC: float = max(0.0, _float("TREND_H1_ENTRY_COOLDOWN_SEC", 120.0))
REENTRY_COOLDOWN_SEC: float = max(0.0, _float("TREND_H1_REENTRY_COOLDOWN_SEC", 240.0))
...
MIN_ATR_PIPS: float = max(0.0, _float("TREND_H1_MIN_ATR_PIPS", 4.5))
MAX_ATR_PIPS: float = max(MIN_ATR_PIPS, _float("TREND_H1_MAX_ATR_PIPS", 110.0))
MIN_FAST_GAP_PIPS: float = max(0.0, _float("TREND_H1_MIN_FAST_GAP_PIPS", 14.0))
