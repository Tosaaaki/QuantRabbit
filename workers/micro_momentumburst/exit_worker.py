...
class MomentumBurstExitWorker:
    ...
    def __init__(self) -> None:
        ...
        self.lock_trigger = max(0.6, _float_env("MOMB_EXIT_LOCK_TRIGGER_PIPS", self.profit_take * 0.35))
        ...
        self.range_lock_trigger = max(0.5, _float_env("MOMB_EXIT_RANGE_LOCK_TRIGGER_PIPS", self.range_profit_take * 0.35))
        ...
        self.tech_take_enabled = _bool_env("MOMB_EXIT_TECH_TAKE_ENABLED", True)
        self.tech_take_min_pips = max(0.2, _float_env("MOMB_EXIT_TECH_TAKE_MIN_PIPS", self.profit_take * 0.5))
