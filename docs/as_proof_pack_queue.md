...
| `failure_trader:AUD_JPY:SHORT:BREAKOUT_FAILURE:LIMIT` | `EVIDENCE_GAP` | 3.7891 | 7 | `True` | RANGE_FORECAST_REQUIRES_RANGE_ROTATION, SELF_IMPROVEMENT_FORECAST_ADVERSE_PATH, BIDASK_REPLAY_NEGATIVE_EXPECTANCY_FOR_LIVE, GUARDIAN_RECEIPT_OPERATOR_REVIEW_REQUIRED, S5_DAILY_SAMPLE_CONCENTRATED, S5_POSITIVE_DAY_RATE_LOW |
