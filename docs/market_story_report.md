...
- Generated at UTC: `2026-05-04T09:29:35.905918+00:00`
...
- Narrative/chart lines mined: `2137`
...
- `news/news_digest.md` kind=`news_digest` lines=47
...
- `USD_JPY` methods: BREAKOUT_FAILURE=103, EVENT_RISK=94, RANGE_ROTATION=87, POSITION_MANAGEMENT=40; themes: intervention=143, breakout_failure=97, range_rail=94, central_bank=65, spread_liquidity=28
...
- `EUR_USD` methods: RANGE_ROTATION=142, BREAKOUT_FAILURE=126, TREND_CONTINUATION=43, POSITION_MANAGEMENT=22; themes: range_rail=167, breakout_failure=105, spread_liquidity=41, intervention=28, event_risk=17
