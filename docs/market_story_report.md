...
- Generated at UTC: `2026-05-04T16:32:44.101654+00:00`
...
- `USD_JPY` methods: BREAKOUT_FAILURE=105, EVENT_RISK=99, RANGE_ROTATION=90, POSITION_MANAGEMENT=40; themes: intervention=146, breakout_failure=99, range_rail=97, central_bank=66, spread_liquidity=28
...
- `AUD_JPY` methods: BREAKOUT_FAILURE=56, RANGE_ROTATION=46, TREND_CONTINUATION=34, EVENT_RISK=13; themes: intervention=58, breakout_failure=52, range_rail=49, spread_liquidity=17, event_risk=12
  - news_digest: EUR/JPY / GBP/JPY / AUD/JPY**: All carry intervention risk. JPY crosses can gap violently on rate check → actual intervention. Size down on all JPY shorts.
