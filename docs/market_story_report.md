...
- Generated at UTC: `2026-05-04T21:21:39.507852+00:00`
...
- `news/news_digest.md` kind=`news_digest` lines=51
...
- `USD_JPY` methods: BREAKOUT_FAILURE=105, EVENT_RISK=99, RANGE_ROTATION=89, POSITION_MANAGEMENT=40; themes: intervention=145, breakout_failure=99, range_rail=96, central_bank=70, spread_liquidity=30
...
- `GBP_USD` methods: RANGE_ROTATION=66, BREAKOUT_FAILURE=49, TREND_CONTINUATION=28, EVENT_RISK=10; themes: range_rail=68, breakout_failure=48, spread_liquidity=28, momentum=17, intervention=9
