...
- Generated at UTC: `2026-05-04T15:52:04.199198+00:00`
...
- `news/news_digest.md` kind=`news_digest` lines=65
...
- `RANGE_ROTATION`: `513`
- `EVENT_RISK`: `315`
- `TREND_CONTINUATION`: `192`
- `POSITION_MANAGEMENT`: `140`

## Pair Story Profiles

- `USD_JPY` methods: BREAKOUT_FAILURE=103, EVENT_RISK=96, RANGE_ROTATION=89, POSITION_MANAGEMENT=40; themes: intervention=143, breakout_failure=97, range_rail=96, central_bank=63, spread_liquidity=29
...
- `GBP_USD` methods: RANGE_ROTATION=66, BREAKOUT_FAILURE=49, TREND_CONTINUATION=28, EVENT_RISK=10; themes: range_rail=68, breakout_failure=48, spread_liquidity=28, momentum=15, event_risk=10
