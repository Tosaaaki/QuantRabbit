...
- Generated at UTC: `2026-05-05T01:58:26.054263+00:00`
...
- `news/news_digest.md` kind=`news_digest` lines=45
...
- `USD_JPY` methods: BREAKOUT_FAILURE=104, EVENT_RISK=92, RANGE_ROTATION=90, POSITION_MANAGEMENT=40; themes: intervention=140, breakout_failure=98, range_rail=97, central_bank=61, spread_liquidity=32
...
- `EUR_USD` methods: RANGE_ROTATION=141, BREAKOUT_FAILURE=126, TREND_CONTINUATION=42, POSITION_MANAGEMENT=22; themes: range_rail=166, breakout_failure=105, spread_liquidity=40, intervention=28, event_risk=17
