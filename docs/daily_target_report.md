...
- Generated at UTC: `2026-07-05T18:09:03.916938+00:00`
- Status: `PURSUE_TARGET`
- Start equity: `287186 JPY`
- Campaign day (JST9): `2026-07-05`
- Target: `28719 JPY` (`10.0%`)
- Minimum daily floor: `14359 JPY` (`5.0%`)
- Realized PnL: `0 JPY`
- Trader unrealized PnL: `0 JPY`
- Progress: `0 JPY` (`0.0%` of target)
- Account unrealized PnL: `-16445 JPY` (includes manual/tagless exposure)
- Account progress: `-16445 JPY` (`-57.3%` of target, broker NAV view)
...
- current_equity_raw: `270740 JPY`
- capital_flows_30d: `100000 JPY`
- funding_adjusted_equity: `170740 JPY`
- rolling_30d_multiplier_raw: `1.5793x`
- rolling_30d_multiplier_funding_adjusted: `0.9959x`
- remaining_to_4x_raw: `415000 JPY`
- remaining_to_4x_funding_adjusted: `515000 JPY`
- Current 30d multiplier: `0.9959x` (funding-adjusted)
- Remaining to 4x: `515000 JPY` (funding-adjusted)
- required_calendar_daily_return_raw: `3.5817%`
- required_active_day_return_raw: `4.9157%`
- required_calendar_daily_return_funding_adjusted: `5.4058%`
- required_active_day_return_funding_adjusted: `7.4432%`
- Required calendar daily return: `5.4058%`
- Required active-day return: `7.4432%`
...
- Current equity estimate: `270740 JPY`
...
- `472987` `EUR_USD SHORT` owner=`operator_manual` units=`30000` upl=`-16445` risk=`unknown` missing=`SL`
