...
- Generated at UTC: `2026-05-04T15:57:45.538936+00:00`
...
- `failure_trader:EUR_USD:LONG:BREAKOUT_FAILURE` status=`LIVE_READY`
  ...
  - risk metrics: risk=`1018.8 JPY` reward=`4829.7 JPY` rr=`4.74` spread=`0.8pip`
- `failure_trader:EUR_USD:SHORT:BREAKOUT_FAILURE` status=`LIVE_READY`
  ...
  - risk metrics: risk=`1018.8 JPY` reward=`6093.7 JPY` rr=`5.98` spread=`0.8pip`
- `failure_trader:GBP_USD:LONG:BREAKOUT_FAILURE` status=`LIVE_READY`
  - note: Dry-run geometry built from current snapshot; live use still requires fresh snapshot at send time.
  - intent: `GBP_USD LONG STOP-ENTRY` units=8000 entry=1.35361 tp=1.35534 sl=1.35283
...
- `range_trader:GBP_USD:LONG:RANGE_ROTATION` status=`LIVE_READY`
  - note: Dry-run geometry built from current snapshot; live use still requires fresh snapshot at send time.
  - intent: `GBP_USD LONG LIMIT` units=8000 entry=1.35296 tp=1.35469 sl=1.35218
  - risk metrics: risk=`981.0 JPY` reward=`2175.9 JPY` rr=`2.22` spread=`1.3pip`
