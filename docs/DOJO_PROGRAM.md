...
| 2025H1 G2六か月稽古 | `WORN TRAIN / RUNNING` | 2020始点の全期間計画とは別に、現在相場へ近い `2025-01〜2025-06` を固定した迅速TRAIN profileを新設。6戦略・28通貨、独立月、OHLC/OLHC、BASE/STRESS、main＋family LOPOを36 job・960セルへ封印した。毎月のM5は14セルでscreenし、pair/currency LOPO・連続口座・M1精査は生存候補のfull profileで課す。六か月完了時だけAI trainerを開き、parameter変更は新generationへ送る。2025は摩耗済みなのでholdout/proofには数えない |
