...
| worker前向きsmoke v1 | `STARTED / HYPOTHESIS` | `[2026-07-20, 2026-08-03)` の12候補×OHLC/OLHCを事前封印。0/14日採取、historical survivor 0なので全候補は仮説のまま |
| AI prompt phase-1 | `REGISTERED / HYPOTHESIS` | 30 blind days×A/B/Cの90セルを固定。新規packet・model response・採点は0/90で、answer-key生成元と外部隔離witnessも未接続 |
