...
- **Breakout-failure MARKET timing (2026-05-22).** A failed-break market entry must be taken from the retest/rejection side of the active M5/M15 box, not from the failed-break side. If a SHORT thesis expects downside but price has not continued through support, do not market-sell near the lower half/support; wait for the bounce into the upper-half resistance retest or use a pending trigger. Symmetrically, if a LONG thesis expects upside but price has not continued through resistance, do not market-buy near the upper half/resistance; wait for the pullback into the lower-half support retest or use a pending trigger. The box midpoint is a geometric support/resistance boundary, not a tuned risk threshold. This prevents the bot-like pattern of selling the low after a failed downside break, then watching the expected relief bounce.
