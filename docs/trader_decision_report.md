...
- Generated at UTC: `2026-04-30T16:55:02.941581+00:00`
- Action: `SEND_ENTRY`
...
- `failure_trader:EUR_USD:LONG:BREAKOUT_FAILURE` score=`164.85` action=`SEND_ENTRY` `EUR_USD LONG BREAKOUT_FAILURE`
...
- `range_trader:EUR_USD:LONG:RANGE_ROTATION` score=`162.85` action=`SEND_ENTRY` `EUR_USD LONG RANGE_ROTATION`
...
- `failure_trader:EUR_USD:SHORT:BREAKOUT_FAILURE` score=`150.14` action=`SEND_ENTRY` `EUR_USD SHORT BREAKOUT_FAILURE`
...
- `range_trader:EUR_USD:SHORT:RANGE_ROTATION` score=`148.14` action=`SEND_ENTRY` `EUR_USD SHORT RANGE_ROTATION`
...
- `trend_trader:EUR_USD:LONG:TREND_CONTINUATION` score=`143.1` action=`SEND_ENTRY` `EUR_USD LONG TREND_CONTINUATION`
...
- `trend_trader:EUR_USD:SHORT:TREND_CONTINUATION` score=`128.39` action=`SEND_ENTRY` `EUR_USD SHORT TREND_CONTINUATION`
...
- `failure_trader:GBP_USD:LONG:BREAKOUT_FAILURE` score=`96.47` action=`NO_TRADE` `GBP_USD LONG BREAKOUT_FAILURE`
  ...
  - blockers: negative live execution history -3935 JPY
- `failure_trader:AUD_JPY:LONG:BREAKOUT_FAILURE` score=`83.41` action=`NO_TRADE` `AUD_JPY LONG BREAKOUT_FAILURE`
  ...
  - blockers: JPY-cross long faces intervention/rate-check narrative risk
...
- `failure_trader:EUR_JPY:LONG:BREAKOUT_FAILURE` score=`54.39` action=`NO_TRADE` `EUR_JPY LONG BREAKOUT_FAILURE`
  ...
  - blockers: negative live execution history -1758 JPY; JPY-cross long faces intervention/rate-check narrative risk
- `range_trader:AUD_JPY:LONG:RANGE_ROTATION` score=`50.91` action=`NO_TRADE` `AUD_JPY LONG RANGE_ROTATION`
  ...
  - blockers: JPY-cross long faces intervention/rate-check narrative risk; visual story explicitly rejected range rotation
- `range_trader:EUR_JPY:LONG:RANGE_ROTATION` score=`25.14` action=`NO_TRADE` `EUR_JPY LONG RANGE_ROTATION`
  ...
  - blockers: negative live execution history -1758 JPY; JPY-cross long faces intervention/rate-check narrative risk; visual story explicitly rejected range rotation
