...
| `manual_excluded_plus_existing_filters_plus_new_family_containment` | 142 | 132 | 10 | 54027.8164 | 380.4776 | 24.166 | 426.9699 | 233.2207 | -546.0 | `False` | `False` | `False` |
...
- `manual_excluded_plus_existing_filters_plus_new_family_containment`: 470992 (-546.0), 471000 (-454.9862), 472792 (-340.2), 470276 (-173.0), 472109 (-172.863)
