...
|---|---|---|---|---|---|---|---|
| `SELF_IMPROVEMENT_P0_PRESENT` | `EXECUTION_LEDGER_STALE` | `ACTIVE_BLOCKER` | none | `False` | `False` | `False` | Repair the named self-improvement P0 and rerun acceptance. |
...
- `EXECUTION_LEDGER_STALE` -> blocks `A/S LIVE_READY, normal routing`; requires: self-improvement-audit must regenerate without this P0 code.
