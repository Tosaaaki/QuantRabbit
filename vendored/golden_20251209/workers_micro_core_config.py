# VENDORED VERBATIM from legacy commit 41644097 (HEAD at 2025-12-09 02:19 UTC,
# five hours before the 53/53 MomentumBurst run). Source: workers/micro_core/config.py
# Do not edit; adapters import from here.
...
COOLDOWN_BASE_SEC: int = int(max(10.0, _float("MICRO_CORE_COOLDOWN_SEC", 45.0)))
