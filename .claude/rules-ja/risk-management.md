...
| 確度 | pretradeスコア | 条件 | サイズ (NAV 180k-200k) | 例 |
|------|------|------|--------|-----|
| **S（鉄板）** | 8+ | H1+H4+マクロ全一致、Div確認 | **8000-10000u** | H4 ADX>30 + H1同方向 + M5押し目 |
| **A（高確度）** | 6-7 | H1方向一致 + M5タイミング確認 | **5000-8000u** | H1 bullish + M5 StochRSI=0.0 |
| **B（普通）** | 4-5 | 1TFのシグナルのみ | **2000-3000u** | M5 Divのみ、H1不明確 |
| **C（試し打ち）** | 0-3 | 根拠薄い | **1000u** | レンジ内逆張り |
