...
|------|------|------|--------|-----|
| **S（鉄板）** | 8+ | H1+H4+マクロ全一致、Div確認 | **NAVの約5%** | H4 ADX>30 + H1同方向 + M5押し目 |
| **A（高確度）** | 6-7 | H1方向一致 + M5タイミング確認 | **NAVの約3%** | H1 bullish + M5 StochRSI=0.0 |
| **B（普通）** | 4-5 | 1TFのシグナルのみ | **NAVの約1%** | M5 Divのみ、H1不明確 |
| **C（試し打ち）** | 0-3 | 根拠薄い | **NAVの約0.5%** | レンジ内逆張り |

NAV 200kの例: S≈10000u, A≈6000u, B≈2000u, C≈1000u。NAV 150kに下がったら: S≈7500u, A≈4500u, B≈1500u, C≈750u。
